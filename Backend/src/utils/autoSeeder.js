...
const autoSeed = async () => {
  try {
    ...
    console.log('Database is empty. Starting auto-seeding of default data...');
    ...
    console.log('Default Admin created: admin@arvo.com / admin123');
    ...
    console.log(`${students.length} default students created.`);
    ...
    console.log('4 default exams created.');

    // 4. Add questions to exam1 (JavaScript)
    ...
    // 6. Add questions to exam3 (Web Dev)
    await Question.create([
      {
        examId: exam3._id,
        type: 'MCQ',
